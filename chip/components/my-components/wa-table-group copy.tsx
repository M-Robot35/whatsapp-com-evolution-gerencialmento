...
import groupParticipants from "@/app/actions/evolutionAction"
...
export default function TableGroup({apikeyy, instanceNamee, grupos }:{apikeyy:string, instanceNamee:string, grupos:IGroup[] }){
    ...
    return (
        <div className="grid grid-cols-1 gap-4">  
            ...
            <section className="grid grid-cols-1 sm:grid-cols-3 gap-2 relative overflow-x-auto  shadow-md sm:rounded-lg  border border-gray-900 p-2">
                ...
                <div className="mt-4 col-span-1">
                    ...
                    {/* <SendMessage apikey={apikeyy} instanceName={instanceNamee} users={usersSend} className="min-h-[250px]"/> */}
                </div>
